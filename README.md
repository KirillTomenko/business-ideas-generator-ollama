...
🔗 [Облачная версия проекта →](https://github.com/ваш-username/business-ideas-generator-cloud)
...
**💡 Есть идеи?** [Создайте Issue](https://github.com/ваш-username/business-ideas-generator-ollama/issues)

---

## 🤝 Участие в проекте

Буду рад вашим улучшениям! Проект открыт для контрибьюторов.
...
3. **Commit** изменения
   ```bash
   git commit -m 'Add: Добавлена потрясающая фича'
   ```
4. **Push** в branch
   ```bash
...
**🎨 Дизайн:**
- Новые темы оформления (минималистичная, киберпанк, классическая)
...
- **Python:** PEP 8
- **JavaScript:** ES6+, использовать `const`/`let`
- **Комментарии:** на русском для основной логики
- **Commits:** в формате `Type: Описание`
  - `Add:` — новая фича
...
- 🐛 **Баги:** [Issues](https://github.com/ваш-username/business-ideas-generator-ollama/issues)
- 💡 **Предложения:** [Discussions](https://github.com/ваш-username/business-ideas-generator-ollama/discussions)
